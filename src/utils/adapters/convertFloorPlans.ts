 ...
 * @module utils/adapters/convertFloorPlans
 */
import { FloorPlan as CoreFloorPlan, Wall as CoreWall } from '@/types/core/FloorPlan';
import { FloorPlan as FloorPlanType, Wall as FPTypeWall } from '@/types/floorPlanTypes';
...
export function convertCoreToFloorPlanType(fp: CoreFloorPlan): FloorPlanType {
  return {
    ...fp,
    walls: fp.walls.map((wall): FPTypeWall => ({
      ...wall,
